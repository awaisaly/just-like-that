...
> = {
  lagos: {
    ...
    blurb: 'Nigeria’s commercial capital — family visits, business, and the energy of the lagoon city.',
    region: 'Nigeria',
  },
  abuja: {
    country: 'Nigeria',
  ...
  london: {
    ...
    blurb: 'The UK capital — Heathrow, onward trains, and easy city links.',
